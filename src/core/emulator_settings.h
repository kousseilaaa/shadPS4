...
struct GPUSettings {
    ...
    Setting<bool> readback_linear_images_sync{false};
    ...
    std::vector<OverrideItem> GetOverrideableFields() const {
        return std::vector<OverrideItem>{
            ...
            make_override<GPUSettings>("readback_linear_images_sync",
                                       &GPUSettings::readback_linear_images_sync),
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(GPUSettings, window_width, window_height, internal_screen_width,
                                   ...
                                   readback_linear_images_sync, direct_memory_access_enabled,
...
#define SETTING_FORWARD_BOOL_READONLY(group, Name, field)                                          \
    ...
    SETTING_FORWARD_BOOL(m_gpu, ReadbackLinearImagesSync, readback_linear_images_sync)
